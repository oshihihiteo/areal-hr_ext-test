...
exports.getOrganizationById = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Ошибка при получении организации: ", error });
  }
};
...
exports.createOrganization = async (req, res) => {
  try {
    ...
    const { error, value } = await organizationSchema.validateAsync(
      organization,
    ...
    res
      .status(500)
      .json({ message: "Ошибка при добавлении организации: ", error });
  }
};
...
exports.deleteOrganization = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Ошибка при удалении организации: ", error });
  }
};
...
exports.editOrganization = async (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Ошибка при редактировании организации: ", error });
  }
};
